...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi Comment           ctermbg=bg   ctermfg=241  cterm=NONE      guibg=bg      guifg=#66face gui=NONE
    hi Conceal           ctermbg=bg   ctermfg=241  cterm=NONE      guibg=bg      guifg=#626262 gui=NONE
    hi Constant          ctermbg=bg   ctermfg=140  cterm=NONE      guibg=bg      guifg=#6fc276 gui=NONE
    ...
    hi StatusLine        ctermbg=237  ctermfg=140  cterm=NONE      guibg=#3a3a3a guifg=#6fc276 gui=NONE
    ...
    hi CursorLineNr      ctermbg=236  ctermfg=140  cterm=NONE      guibg=#303030 guifg=#6fc276 gui=NONE
    hi Cursor            ctermbg=140  ctermfg=251  cterm=NONE      guibg=#6fc276 guifg=#c6c6c6 gui=NONE
    ...
    hi PmenuSel          ctermbg=236  ctermfg=140  cterm=NONE      guibg=#303030 guifg=#6fc276 gui=NONE
    ...
    hi Search            ctermbg=140  ctermfg=235  cterm=NONE      guibg=#6fc276 guifg=#262626 gui=NONE
    hi Directory         ctermbg=NONE ctermfg=140  cterm=NONE      guibg=NONE    guifg=#6fc276 gui=NONE
    ...
    hi helpHyperTextJump ctermbg=bg   ctermfg=140  cterm=NONE      guibg=bg      guifg=#6fc276 gui=NONE
...
if has('nvim')
    ...
    let g:terminal_color_13 = '#6fc276'
